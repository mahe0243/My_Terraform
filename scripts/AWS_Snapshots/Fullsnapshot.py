...
((.venv) ) @mahe0243 ➜ /workspaces/My_Terraform/snapshot/fullsnap (main) $ ^C
((.venv) ) @mahe0243 ➜ /workspaces/My_Terraform/snapshot/fullsnap (main) $ cls
bash: cls: command not found
((.venv) ) @mahe0243 ➜ /workspaces/My_Terraform/snapshot/fullsnap (main) $ clean
bash: clean: command not found
((.venv) ) @mahe0243 ➜ /workspaces/My_Terraform/snapshot/fullsnap (main) $ 
((.venv) ) @mahe0243 ➜ /workspaces/My_Terraform/snapshot/fullsnap (main) $ cat snapshot.py 
import boto3
import argparse
import datetime
